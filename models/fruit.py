...
class Fruit(BaseModel):
    ...
    Attributes:
        ...
        created_at: Timestamp when the fruit was added
    ...
    def validate(self) -> bool:
        ...
        return (
            ...
            isinstance(self.category, str) and len(self.category.strip()) > 0
        )
    ...
    def __str__(self) -> str:
        ...
        Returns:
            Human-readable string describing the fruit
        """
